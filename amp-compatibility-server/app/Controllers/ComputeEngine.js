...
class ComputeEngine {
	...
	async setup() {
		...
		// Temporary disabling marking secondary instance as "development". Since marking App as none production. It won't able to communicate with GCP MySQL instance.
